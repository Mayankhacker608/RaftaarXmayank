    ...
    >
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-10 md:flex-row md:items-start">
        ...
        >
          ...
          <button className="rounded-lg bg-gradient-to-r from-yellow-400 to-yellow-600 px-6 py-3 font-semibold text-black transition-transform duration-300 hover:scale-105">
            Learn More
          </button>
        </motion.div>
      </div>
